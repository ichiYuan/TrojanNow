...
public class MsgActivity extends ActionBarActivity implements MyResultReceiver.Receiver {
    ...
    void sendRequestInboxMsgs() {

    }

    // get all message in outbox
    void sendRequestOutboxMsgs() {
