 ...
 */
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>, MyResultReceiver.Receiver {
...
//    }
    ...
    void sendLogin(String email, String password) {
        String url = "https://rails-tutorial-cosimo-dw.c9.io/login.json";
